...
.SILENT all:
	...
	$(call perform_test,great,Great)
	$(call perform_test,mixed,Mixed)
...
generate:
	...
	$(call generate_answers,great)
	$(call generate_answers,mixed)
...
merge:
	...
	$(call merge_test,great)
	$(call merge_test,mixed)
